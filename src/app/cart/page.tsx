...
import { deleteFromCart } from "@/hooks/useDeleteFromCart";
import { refreshCart } from "@/hooks/useRefreshCart";
                        ...
                        <div className={styles.container22}>
                         ...
                         <div className={styles.vashzakaz}>
                            ...
                            <div className={styles.sector22}>
                                <div className={styles.tovari}></div>
